...
// SPHINCS+-256f-simple Signature Scheme
namespace sphincs_plus_256f_simple {

// SPHINCS+-256f-simple parameter set, as specified in table 3 of https://sphincs.org/data/sphincs+-r3.1-specification.pdf.
