...
// SPHINCS+-256s-robust Signature Scheme
namespace sphincs_plus_256s_robust {

// SPHINCS+-256s-robust parameter set, as specified in table 3 of https://sphincs.org/data/sphincs+-r3.1-specification.pdf.
