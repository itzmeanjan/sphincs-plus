...
// SPHINCS+-192s-robust Signature Scheme
namespace sphincs_plus_192s_robust {

// SPHINCS+-192s-robust parameter set, as specified in table 3 of https://sphincs.org/data/sphincs+-r3.1-specification.pdf.
