...
// SPHINCS+-192s-simple Signature Scheme
namespace sphincs_plus_192s_simple {

// SPHINCS+-192s-simple parameter set, as specified in table 3 of https://sphincs.org/data/sphincs+-r3.1-specification.pdf.
