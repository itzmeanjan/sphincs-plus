...
// SPHINCS+-128f-robust Signature Scheme
namespace sphincs_plus_128f_robust {

// SPHINCS+-128f-robust parameter set, as specified in table 3 of https://sphincs.org/data/sphincs+-r3.1-specification.pdf.
